...
public interface ITreatmentImporter {
	...
	public Consumer<Treatment> importRadiologyTreatment(UUID tid, Patient patient, Provider provider, String diagnosis, List<LocalDate> dates,
	...
	public Consumer<Treatment> importPhysiotherapyTreatment(UUID tid, Patient patient, Provider provider, String diagnosis, List<LocalDate> dates,
			Consumer<Treatment> consumer);
