...
public class Provider implements Serializable, ITreatmentImporter {
	...
	@Override
	public Consumer<Treatment>  importRadiologyTreatment(UUID tid, Patient patient, Provider provider, String diagnosis, List<LocalDate> dates, Consumer<Treatment> consumer) {
		// TODO finish this
	...
	@Override
	public Consumer<Treatment> importSurgeryTreatment(UUID tid, Patient patient, Provider provider, String diagnosis, LocalDate date,
	...
	@Override
	public Consumer<Treatment> importPhysiotherapyTreatment(UUID tid, Patient patient, Provider provider, String diagnosis,
