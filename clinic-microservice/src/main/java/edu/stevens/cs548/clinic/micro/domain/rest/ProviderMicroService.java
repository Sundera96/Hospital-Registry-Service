...
public class ProviderMicroService {
	...
	private void addTreatmentImpl(TreatmentDto dto, Consumer<Treatment> parentFollowUps)
		...
		if (dto instanceof DrugTreatmentDto) {
			...
			followUpsConsumer = provider.importSurgeryTreatment(dto.getId(),patient,provider,dto.getDiagnosis(),
			...
			followUpsConsumer = provider.importPhysiotherapyTreatment(dto.getId(),patient,provider,dto.getDiagnosis(),
			...
			followUpsConsumer = provider.importRadiologyTreatment(dto.getId(),patient,provider,dto.getDiagnosis(),
